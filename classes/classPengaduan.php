...
class Pengaduan extends Connect{
    ...
    public function addPengaduan($data){
        $conn = $this->getConnection();
        $id_pelapor = $this->pelaporTerakhir();
        ...
        $query3 = "INSERT INTO pelapor VALUES 
        (null,?,?,?)";    
        $stmt3 = $conn->prepare($query3);
        $stmt3->bindParam(1,$nama_pelapor);
        $stmt3->bindParam(2,$jabatan_pelapor);
        $stmt3->bindParam(3,$bagian_pelapor);
        $stmt3->execute();
        return true;
    }
