  ...
  <div class="row">
    <div class="col-12 p-3 bg-white">
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <input type="text" name="nama_pelapor" class="form-control" required placeholder="Nama">
            </div>
            <div class="mb-3">
                <input type="text" name="jabatan_pelapor" class="form-control" required placeholder="Jabatan">
            </div>
            <div class="mb-3">
                <input type="text" name="bagian_pelapor" class="form-control" required placeholder="Bagian">
            </div>
            <div class="mb-3">
